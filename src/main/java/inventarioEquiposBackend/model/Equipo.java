...
public class Equipo {
    ...
    public Equipo(Long id, String nombreEquipo, String descripcion, String tipo, String modelo, String marca, String serie, String ubicacionDelEquipo, String utilizacion, String recibidoPor, String proveedor, String ordenDeCompra, String factura, Date fechaDeCompra, Date fechaFinGarantia, String garantia, Double precio, String procesador, int memoriaRamGB, int almacenamientoGB, String tipoAlmacenamiento, String placaBase, int fuentePoderWatts, String tarjetaGrafica, boolean tieneTarjetaRed, boolean tieneTarjetaSonido, String gabinete, String perifericosEntrada, String perifericosSalida, String componentes, String accesorios, String sistemaOperativo, String versionSO, String driversInstalados, String programasInstalados, String utilidadesSistema, String direccionIP, String direccionMAC) {
        this.id = id;
    ...
    public @Positive(message = "El precio debe ser un valor positivo") Double getPrecio() {
        return precio;
    }

    public void setPrecio(@Positive(message = "El precio debe ser un valor positivo") Double precio) {
        this.precio = precio;
    }
